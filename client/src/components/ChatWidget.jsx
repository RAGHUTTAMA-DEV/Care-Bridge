                            ...
                            <div key={categoryIdx} className="mb-4">
                                ...
                                <div className="space-y-2">
                                    {category.questions.map((question, questionIdx) => (
                                        ...
                                        >
                                            <svg
                                                className="w-5 h-5 text-blue-500 group-hover:text-blue-600 group-active:text-blue-700"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                stroke="currentColor"
                                            >
                                            ...
                                            <div className="absolute inset-0 bg-blue-50 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-200"></div>
                                        </button>
                                    ))}
                                </div>
                            </div>
